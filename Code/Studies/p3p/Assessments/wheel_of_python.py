...
class WOFComputerPlayer(WOFHumanPlayer):
    ...
    #needed to use super here to use the attributes of WOFPlayer
    ...
    def getPossibleLetters(self,guessed):
        ...
        if self.prizeMoney < VOWEL_COST:
            ...
            #long ay of writing this ^
            # new_possible_letters = []
            # for letter in possible_letters:
            #     if letter not in VOWELS:
            #         new_possible_letters.append(letter)
    ...
    def getMove(self, category, obscuredPhrase, guessed):
        ...
        if not possible_letters:
            ...
            if not self.smartCoinFlip():
                letters = [letter for letter in possible_letters if letter not in VOWELS]
